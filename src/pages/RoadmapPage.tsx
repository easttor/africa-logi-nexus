        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-lg font-semibold text-foreground">6-Month Development Roadmap</h1>
            </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Be part of Africa's logistics transformation. Explore our platform and see how we're building the future of supply chain management.
          </p>
